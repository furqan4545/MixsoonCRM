...
// PATCH /api/alerts/templates/:id — Update an email template
export async function PATCH(
  ...
  try {
    ...
    console.error("[PATCH /api/alerts/templates/:id]", error);
    return NextResponse.json(
...
// DELETE /api/alerts/templates/:id — Delete an email template
export async function DELETE(
  ...
  try {
    ...
    console.error("[DELETE /api/alerts/templates/:id]", error);
    return NextResponse.json(
