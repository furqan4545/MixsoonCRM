...
import { ContractSigningView } from "@/components/contract-signing-view";
...
export default async function ContractSigningPage({
  ...
  return (
    <div>
      <div className="mb-8">
        <h1 className="text-2xl font-bold">Contract for {record.influencer.displayName || record.influencer.username}</h1>
      ...
      <ContractSigningView
        ...
        influencerName={record.influencer.displayName || record.influencer.username}
      />
    </div>
  );
}
